                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    $sql="select * from basededatos.persona xp,flujoprocesoseguimiento xf 
                                    where xp.usuario=xf.Usuario and (xf.rechazo='Aceptado' or xf.rechazo='Rechazado')
                                    order by xp.apellido";
